...
`)
	...
	// Start/Close are always emitted and unconditionally reference these.
	it.imports["context"] = "context"
	it.imports["errors"] = "errors"
	it.imports["github.com/ramory-l/easydi/lifecycle"] = "lifecycle"
